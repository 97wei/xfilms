<template>
  <div class="search_body">
    ...
    <div class="search_result">
      ...
      <ul>
        <li>
          <div class="img"><img src="../../../public/image/wuming.jpg" ></div>
          <div class="info">
            <p><span>无名之輩</span><span>8.5</span></p>
            <p>A Cool Fish</p>
            <p>剧情,喜剧，犯罪</p>
            <p>2018-11-16</p>
          </div>
...
.search_body .search_input_wrapper{ padding: ➊10px; border: 1px solid ■#e6e6e6; border-radius: 5px; background-color: #fff;display: ;}
